...
[YtrainPred,prob] = classify(net,augimdsTrain);
Ytrain = imdsTrain.Labels;
trainaccuracy = mean(YtrainPred == Ytrain)
trainscores = predict(net,augimdsTrain)
...
augimdsValidation = augmentedImageDatastore(inputSize(1:2),imdsValidation);
[YValPred,probs] = classify(net,augimdsValidation);
YValidation = imdsValidation.Labels;
accuracy = mean(YValPred == YValidation)
scores = predict(net,augimdsValidation);
